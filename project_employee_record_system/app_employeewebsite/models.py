...
class Department(models.Model):
    ...
    class Meta: #represent group of data
...
class Employee(models.Model):
    ...
    user = models.ForeignKey(User, on_delete = models.CASCADE) #if delete all linked with particular user gets deleted in Casade
